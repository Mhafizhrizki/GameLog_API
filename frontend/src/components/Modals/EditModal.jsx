...
const EditModal = ({ gameLog, onClose, onSave }) => {
  ...
  useEffect(() => {
    if (gameLog) {
      setStatus(gameLog.status);
      setRating(gameLog.personal_rating);
    }
  }, [gameLog]);
  ...
  return (
    <div style={{
      ...
      <div className="glass-card animate-fade-in" style={{
        ...
        <h2 style={{ fontSize: '1.4rem', marginBottom: '1.5rem' }}>Edit Game</h2>
